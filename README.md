# 📂 Spring Boot 파일 업로드 실습 프로젝트 (fileupload)
...
### 2단계: JPA Auditing & 사용자 프로필 등록 (`UserProfile`)
...
### 4단계: 클라우드 S3 스토리지 연동 및 파일 스트리밍 (`S3FileStore`)
